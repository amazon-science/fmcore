...
from fmcore.data import FileMetadata, ScalableDataFrame, ScalableSeries, ScalableSeriesRawType
from fmcore.framework import Algorithm, Predictions, load_predictions
from fmcore.framework.task.embedding import EMBEDDINGS_COL, Embedder, EmbeddingData, Embeddings
        ...
        def set_faiss_index_params(cls, params: Dict) -> Dict:
            ...
            if distance_metric is None:
                ...
                if (
                    ...
                    and cls._mapping[index_name] != faiss.IndexFlatIP
                ):
                    raise ValueError(
                ...
                if (
                    ...
                    and cls._mapping[index_name] != faiss.IndexFlat
                ):
                    raise ValueError(
                        f"When using distance_metric={distance_metric}, "
