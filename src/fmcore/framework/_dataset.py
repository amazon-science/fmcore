from abc import ABC
from typing import ClassVar, Dict, List, NoReturn, Optional, Set, TypeVar, Union

from bears import FileMetadata
from bears.core.frame import ScalableDataFrame, ScalableOrRaw
from bears.reader import DataFrameReader, JsonReader
...
from bears.writer import DataFrameWriter, JsonWriter
from pydantic import model_validator

from fmcore.constants import FILE_FORMAT_TO_FILE_ENDING_MAP, DataSplit, FileFormat, MLTypeSchema
from fmcore.framework._task_mixins import InputOutputDataMixin, SchemaValidationError, TaskOrStr
...
class Dataset(InputOutputDataMixin, Registry, ABC):
    ...
    def visualize(
        ...
        **kwargs,
        ...
        from fmcore.framework._visualize import Visualization
