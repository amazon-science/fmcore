...
from fmcore.constants import FILE_FORMAT_TO_FILE_ENDING_MAP, FileContents, FileFormat, Storage
    ...
    def write(
        ...
        **kwargs,
        ...
        ## Add any other remote storage solutions here.
            ...
            raise IOError(
                f"Cannot write object of type {type(data)} to destination of type {type(destination)}"
            )
        return False
    ...
    def write_stream(
        ...
        **kwargs,
        ...
        try:
            ...
            stream.seek(
                start_point
            )  ## So that a subsequent call to .read() will return the contents we have written.
