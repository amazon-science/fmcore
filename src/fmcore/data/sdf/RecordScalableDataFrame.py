...
from fmcore.util import String, any_are_not_none, as_list, safe_validate_arguments
    ...
    def __getitem__(self, key) -> Union[Any, RecordScalableDataFrame, DatumScalableSeries]:
        ...
        if isinstance(key, np.ndarray):
            ...
            if key == 0 or key is True:
                ...
                return self._empty_datum_series
            raise KeyError("When indexing with a List or Numpy array, must pass the index as 0 or True")
