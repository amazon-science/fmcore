...
from fmcore.constants import (
    ...
    SS_DATA_LAYOUT_PRIORITY,
    TENSOR_SS_DATA_LAYOUT_PRIORITY,
    DataLayout,
)
...
class ScalableSeries(Registry, ABC):
    ...
    def of(
        ...
        **kwargs,
        ...
        if layout is None:
            return (
                data  ## If data is ScalableSeries and layout is None, return data (SS) without modification
            )
